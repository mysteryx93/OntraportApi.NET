...
namespace EmergenceGuardian.OntraportApi
{
    ...
    public interface IOntraportForms : IOntraportBaseRead<ApiForm>
    {
        ...
        Task<string> SelectSmartFormHtmlAsync(int formId);
        ...
        Task<IDictionary<string, string>> SelectAllFormBlocksAsync(int? page = null);
        ...
        Task<IEnumerable<string>> SelectBlocksByFormNameAsync(string formName);
    }
}
