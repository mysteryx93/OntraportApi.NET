...
namespace HanumanInstitute.OntraportApi
{
    ...
    public interface IOntraportTasks : IOntraportBaseRead<ApiTask>
    {
        ...
        Task<ApiTask> UpdateAsync(int taskId, int? owner = null, DateTimeOffset? dateDue = null, ApiTask.TaskStatus? status = null);
        ...
        /// <returns></returns>
        Task RescheduleAsync(int id, DateTimeOffset newTime);
    }
}
