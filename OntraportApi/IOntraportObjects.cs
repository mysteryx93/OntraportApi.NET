...
namespace EmergenceGuardian.OntraportApi
{
    ...
    public interface IOntraportObjects
    {
        ...
        Task<Dictionary<string, string>> SelectAsync(ApiObjectType objectType, int objectId);
        ...
        Task<List<Dictionary<string, string>>> SelectMultipleAsync(ApiObjectType objectType, ApiSearchOptions searchOptions = null, ApiSortOptions sortOptions = null, IEnumerable<string> externs = null, IEnumerable<string> listFields = null);
        ...
        Task<int?> GetObjectIdByEmailAsync(ApiObjectType objectType, string email);
        ...
        Task<IEnumerable<int>> GetObjectIdByEmailAllAsync(ApiObjectType objectType, string email);
        ...
        Task<Dictionary<int, ResponseMetadata>> GetAllMetadataAsync();
        ...
        /// <param name="objectType">The object type.</param>
        /// <returns>A JObject providing raw access to the JSON data.</returns>
        Task<ResponseMetadata> GetMetadataAsync(ApiObjectType objectType);
        ...
        Task<ResponseSectionFields> SelectFieldsBySectionAsync(ApiObjectType objectType, string sectionName);
        ...
        Task<Dictionary<int, ResponseSectionFields>> SelectAllFieldsAsync(ApiObjectType objectType);
        ...
        Task<ApiFieldInfo> SelectFieldByNameAsync(ApiObjectType objectType, string fieldName);
        ...
        /// <param name="objectType">The object type.</param>
        /// <param name="objectId">The ID of the specific object.</param>
        Task DeleteAsync(ApiObjectType objectType, int objectId);
        ...
        /// <param name="objectType">The object type.</param>
        /// <param name="sectionName">The name of the section.</param>
        Task DeleteSectionAsync(ApiObjectType objectType, string sectionName);
        ...
        Task DeleteFieldAsync(ApiObjectType objectType, string fieldName);
