    ...
    where T : ApiCustomObjectBase
{
    ...
    Task AddToSequenceAsync(int id, int sequenceId, CancellationToken cancellationToken = default);
    ...
    Task AddToSequenceAsync(int id, IEnumerable<int> sequenceIds, CancellationToken cancellationToken = default);
    ...
    /// <param name="sequenceIds">A list of the sequence(s) to which objects should be added.</param>
    Task AddToSequenceAsync(ApiSearchOptions searchOptions, IEnumerable<int> sequenceIds, CancellationToken cancellationToken = default);
    ...
    Task AddTagAsync(int id, int tagId, CancellationToken cancellationToken = default);
    ...
    Task AddTagAsync(int id, IEnumerable<int> tagIds, CancellationToken cancellationToken = default);
    ...
    /// <param name="searchOptions">The search options.</param>
    /// <param name="tagIds">A list of the IDs of the tag(s) which should be added to objects.</param>
    Task AddTagAsync(ApiSearchOptions searchOptions, IEnumerable<int> tagIds, CancellationToken cancellationToken = default);
    ...
    Task AddTagNamesAsync(int id, string tagName, CancellationToken cancellationToken = default);
    ...
    Task AddTagNamesAsync(int id, IEnumerable<string> tagNames, CancellationToken cancellationToken = default);
    ...
    Task AddToCampaignAsync(int id, int campaignId, CancellationToken cancellationToken = default);
    ...
    Task AddToCampaignAsync(int id, IEnumerable<int> campaignIds, CancellationToken cancellationToken = default);
    ...
    /// <param name="searchOptions">The search options.</param>
    /// <param name="campaignIds">A list of the campaign(s) to which objects should be added.</param>
    Task AddToCampaignAsync(ApiSearchOptions searchOptions, IEnumerable<int> campaignIds, CancellationToken cancellationToken = default);
    ...
    Task RemoveFromSequenceAsync(int id, int sequenceId, CancellationToken cancellationToken = default);
    ...
    Task RemoveFromSequenceAsync(int id, IEnumerable<int> sequenceIds, CancellationToken cancellationToken = default);
    ...
    /// <param name="searchOptions">The search options.</param>
    /// <param name="sequenceIds">A list of the sequence(s) from which objects should be removed.</param>
    Task RemoveFromSequenceAsync(ApiSearchOptions searchOptions, IEnumerable<int> sequenceIds, CancellationToken cancellationToken = default);
    ...
    Task RemoveTagAsync(int id, int tagId, CancellationToken cancellationToken = default);
    ...
    Task RemoveTagAsync(int id, IEnumerable<int> tagIds, CancellationToken cancellationToken = default);
    ...
    /// <param name="searchOptions">The search options.</param>
    /// <param name="tagIds">A list of the IDs of the tag(s) which should be removed from objects.</param>
    Task RemoveTagAsync(ApiSearchOptions searchOptions, IEnumerable<int> tagIds, CancellationToken cancellationToken = default);
    ...
    Task RemoveTagNamesAsync(int id, string tagName, CancellationToken cancellationToken = default);
    ...
    Task RemoveTagNamesAsync(int id, IEnumerable<string> tagNames, CancellationToken cancellationToken = default);
    ...
    Task RemoveFromCampaignAsync(int id, int campaignId, CancellationToken cancellationToken = default);
    ...
    Task RemoveFromCampaignAsync(int id, IEnumerable<int> campaignIds, CancellationToken cancellationToken = default);
    ...
    /// <param name="searchOptions">The search options.</param>
    /// <param name="campaignIds">A list of the campaign(s) from which objects should be removed.</param>
    Task RemoveFromCampaignAsync(ApiSearchOptions searchOptions, IEnumerable<int> campaignIds, CancellationToken cancellationToken = default);

    /// <summary>
    /// Pauses rules, sequences, and sequence subscribers.
    /// </summary>
    /// <param name="id">The id of the object to affect.</param>
    Task PauseRuleOrSequenceAsync(int id, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    /// <param name="id">The id of the object to affect.</param>
    Task UnpauseRuleOrSequenceAsync(int id, CancellationToken cancellationToken = default);
